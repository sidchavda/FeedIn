...
class FetchBbcGujaratiNews extends Command
{
    protected $signature = 'news:fetch-bbc-gujarati
    ...
    public function handle(): int
    {
        ...
        $feedList = $this->option('source')
            ? [['url' => $this->option('source'), 'source' => 'BBC Gujarati']]
            : $this->feeds;
