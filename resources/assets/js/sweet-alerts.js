(function () {
    ...
    document.getElementById('alert-image').onclick = function () {
        Swal.fire({
            ...
            imageUrl: 'http://127.0.0.1:8000/build/assets/img/media/6.jpg',
            imageWidth: 400,
            imageHeight: 200,
    ...
    document.getElementById('alert-custom-bg').onclick = function () {
        Swal.fire({
            ...
            padding: '3em',
            color: '#716add',
            background: 'url(http://127.0.0.1:8000/build/assets/img/media/5.jpg)',
            backdrop: `
              rgba(0,0,0,0.3)
              url(http://127.0.0.1:8000/build/assets/img/gif's/1.gif)
              left top
              no-repeat
            `
        })
